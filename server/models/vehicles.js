...
const vehicleShema = mongoose.Schema(
  {
    ...
    cat: { // категория
      type: String,
      enum: ['Грузовой самосвал', 'Легковой универсал', 'Легковой седан', 'Легковой хетчбек', 'Легковой прочее', 'Грузовой прочее', 'Топливозаправщик', 'Экскаватор', 'Кран', 'Бульдозер', 'Погрузчик', 'Грузовой тягач седельный'],
      minlength: 5,
      maxlength: 50,
      required: true,
    },
